/* socklib.c
 *
 * This file functions used lots when writing internet
 * client/server program. The two main function here are:
 *
...
int connect_to_server( char *host, int portnum )
{
    ...
    if ( hp == NULL )
        return -1;
    bcopy( (void *)hp->h_addr, (struct sockaddr *)&servadd.sin_addr,
            hp->h_length );
