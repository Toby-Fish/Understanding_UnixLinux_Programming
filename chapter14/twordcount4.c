/* twordcount1.c - threaded word counter for two files.
...
int main( int ac, char *av[] )
{
    ...
    pthread_mutex_lock( &lock );                    /* lock the reoprt box now */
...
{
    struct arg_set *args = (struct arg_set *)a;     /* cast arg back to correct type */
    FILE *fp;
    int c, prevc = '\0';
